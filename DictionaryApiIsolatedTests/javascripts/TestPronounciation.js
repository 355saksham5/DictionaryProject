...
describe('Test For', function () {
    ...
    describe('GetPronounciation', () => {
        it('on getting correct authorization jwt and available word return 200 and pronounciation of word', function (done) {
            hippie(dereferencedSwagger, hippieOptions)
                ...
                .end(function (err, res, body) {
                    ...
                    expect(body).to.equal("pronounciation of apple");
                    done();
                });
        });
