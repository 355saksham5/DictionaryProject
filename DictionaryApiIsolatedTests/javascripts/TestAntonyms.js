...
describe('Test For', function () {
    ...
    describe('GetAntonyms', () => {
        it('on getting correct authorization jwt and available word return 200 and antonym of word', function (done) {
            hippie(dereferencedSwagger, hippieOptions)
                ...
                .end(function (err, res, body) {
                    ...
                    expect(body[0]).to.equal("antonym of apple");
                    done();
                });
        });
